...
namespace kfr {
    ...
    */
    ...
    constexpr std::array<std::pair<audio_sample_type, std::string_view>, 7> audio_sample_type_entries = {{
    ...
    constexpr std::string_view audio_sample_type_to_string(audio_sample_type t) {
        for (const auto& [type, str] : audio_sample_type_entries)
            if (type == t) return str;
        return "";
    }

    constexpr std::array<std::pair<audio_sample_type, int>, 7> audio_sample_type_precision_entries = {{
