...
Filename: "{app}\bin\kirawavtar-cli.exe"; Parameters: "install-cli"; StatusMsg: "Installing CLI tool..."; Flags: waituntilterminated runhidden; Tasks: addtopath
Filename: "{app}\bin\KiraWAVTar.exe"; Description: "Launch KiraWavTar"; Flags: nowait postinstall skipifsilent

[UninstallRun]
Filename: "{app}\bin\kirawavtar-cli.exe"; Parameters: "uninstall-cli"; Flags: waituntilterminated runhidden
